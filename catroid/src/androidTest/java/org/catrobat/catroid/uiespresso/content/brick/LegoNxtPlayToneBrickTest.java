...
public class LegoNxtPlayToneBrickTest {
	...
	public void nxtPlayToneTest() {
		...
		enterValueInFormulaTextFieldOnBrickAtPosition(newValue, R.id.nxt_tone_freq_edit_text, brickPosition);
		enterValueInFormulaTextFieldOnBrickAtPosition(newValue, R.id.nxt_tone_duration_edit_text, brickPosition);
	}
}